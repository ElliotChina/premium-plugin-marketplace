...
Charts are added using the [reveal.js-plugins/chart](plugins/plugin-chart.md) plugin, which integrates Chart.js into your slides.
...
<section style="display: flex; flex-direction: column; height: 100%;">
  ...
  <div style="flex: 1; display: grid; grid-template-columns: 1fr 1fr; gap: 30px; min-height: 0; min-width: 0;">
    <div style="display: flex; flex-direction: column; justify-content: center; background: var(--secondary-color); padding: 20px; border-radius: var(--box-radius);">
...
<section style="display: flex; flex-direction: column; height: 100%;">
  ...
  <div style="flex: 1; display: grid; grid-template-rows: 1fr 1fr; gap: 20px; min-height: 0; min-width: 0;">
    <div style="display: flex; align-items: center; justify-content: center; background: var(--secondary-color); padding: 20px; border-radius: var(--box-radius);">
      <div>
...
<section style="display: flex; flex-direction: column; height: 100%;">
  ...
  <div style="flex: 1; display: grid; grid-template-rows: 1fr 3fr; gap: 20px; min-height: 0; min-width: 0;">
    <div style="display: flex; align-items: center; background: var(--secondary-color); padding: 15px 20px; border-radius: var(--box-radius);">
...
<section style="display: flex; flex-direction: column; height: 100%;">
  ...
  <div style="flex: 1; display: grid; grid-template-rows: 1fr 2fr; gap: 20px; min-height: 0; min-width: 0;">
    <div style="display: flex; flex-direction: column; justify-content: center; background: var(--secondary-color); padding: 15px 20px; border-radius: var(--box-radius);">
...
<section style="display: flex; flex-direction: column; height: 100%;">
  ...
  <div style="flex: 1; display: grid; grid-template-columns: 1fr 1fr; grid-template-rows: 1fr 1fr; gap: 15px; min-height: 0; min-width: 0;">
    <div style="display: flex; align-items: center; justify-content: center; background: var(--secondary-color); padding: 15px; border-radius: var(--box-radius);">
      <div style="text-align: center;">
        <p style="font-size: 2em; margin: 0; color: var(--primary-color);">$2.4M</p>
        <p style="margin: 0;" class="text-muted">Total Revenue</p>
      </div>
    </div>
    <div style="display: flex; align-items: center; justify-content: center; background: var(--secondary-color); padding: 15px; border-radius: var(--box-radius);">
      <div style="text-align: center;">
        <p style="font-size: 2em; margin: 0; color: var(--primary-color);">+18%</p>
        <p style="margin: 0;" class="text-muted">Growth Rate</p>
      </div>
    </div>
    <div style="display: flex; align-items: center; justify-content: center; background: var(--secondary-color); padding: 15px; border-radius: var(--box-radius);">
      <div style="text-align: center;">
        <p style="font-size: 2em; margin: 0; color: var(--primary-color);">847</p>
        <p style="margin: 0;" class="text-muted">New Customers</p>
      </div>
    </div>
    <div style="position: relative; min-height: 0; min-width: 0;">
...
**Complete Plugin Reference**: See [plugin-chart.md](plugin-chart.md) for:
- Full configuration options and all available parameters
- Advanced customization settings
- All chart types and their specific configurations
- External CSV file handling
- Detailed plugin behavior explanations

## References

- [Chart.js Plugin](plugins/plugin-chart.md)
